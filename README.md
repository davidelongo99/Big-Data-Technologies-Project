...
- Index:
> get_ministry_data.ipynb 
is used to produce a list of datasets published by Italian's Ministry of  University and Scientific Research. 
...
is used to store all the datasets present within the dictionary produced by get_ministry_data in our Google Cloud Storage Bucket, temporarily downloading it and removing it immediately after. A class is introduced in order to reiterate this process on a fixed interval of 15 days.
